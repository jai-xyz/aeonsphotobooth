...
<!-- 
                    <form
                        class="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit"
                    >
                        <article class="mb-5">
                            <footer
                            ...
                            <p class="mb-2 text-gray-900 dark:text-white">
                                ...
                                <a
                                    href="#"
                                    class="font-medium hover:underline text-primary-600 dark:text-primary-500"
                                    >@designteam</a
                                >
                                Let's schedule a kick-off meeting and workshop
                                this week. It would be great to gather everyone
                                involved in the design project. Let me know
                        ...
                        <article class="mb-5">
                            ...
                            <p class="mb-2 text-gray-900 dark:text-white">
                                Thank you for the workshop, it was very
                                productive meeting. I can't wait to start
                                working on this new project with you guys. But
                                first things first, I'am waiting for the offer
                                and pitch deck from you. It would be great to
                        ...
                        <article class="mb-5">
                            ...
                            <p class="mb-2 text-gray-900 dark:text-white">
                                ...
                                <a
                                    ...
                                    >@team</a
                                >
                                I'am attaching our offer and pitch deck. Take
                                your time to review everything. I'am looking
                            ...
                            <div class="items-center 2xl:space-x-4 2xl:flex">
                                ...
                                >
                                    ...
                                    >
                                        <svg
                                            class="w-5 h-5 text-teal-600 lg:w-6 lg:h-6 dark:text-teal-300"
                                            fill="currentColor"
                                            viewBox="0 0 20 20"
                                            xmlns="http://www.w3.org/2000/svg"
                                            aria-hidden="true"
                        ...
                        <article class="pl-12 mb-5">
                            ...
                            <p class="mb-2 text-gray-900 dark:text-white">
                                ...
                                <a
                                    ...
                                    >@jeseleos</a
                                >
                                I need some informations about flowbite react
                                version.
                            </p>
                        </article>
                        <article class="pl-12 mb-5">
                            ...
                            <p class="mb-4 text-gray-900 dark:text-white">
                                ...
                                <a
                                    ...
                                    >@josephh</a
                                >
                                Sure, just let me know whean you are available
                                and we can speak.
                            </p>
                            <form>
                ...
                <div class="grid gap-4">
                    ...
                    >
                        ...
                        <!-- Card Footer -->
                        <div
                            class="flex items-center justify-between pt-4 lg:justify-evenly sm:pt-6"
                        >
                            <div>
                                <!-- <svg
