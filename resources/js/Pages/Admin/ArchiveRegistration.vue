...
const changePage = (page) => {
    Inertia.get(
        route("event.archive.index", { page }),
        {},
        {
            preserveScroll: true,
            preserveState: true,
...
let eventUrl = computed(() => {
    let url = new URL(route("event.archive.index"));
...
// Function to check if an event date is in the future
const isFutureEvent = (eventDate) => {
    return new Date(eventDate) >= new Date(currentDate.value);
};
...
const updateStatus = () => {
    form.patch(route("event.archive.update", { event: form.id }), {
        preserveScroll: true,
                            ...
                            >
                                ...
                                >
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        ...
                                        <button
                                            v-if="isFutureEvent(event.date) && event.status === 'Cancel'"
                                            @click="
                                                openConfirmationModal(event.id)
                                            "
                                            class="inline-flex items-center p-2 text-xs font-medium text-center text-white rounded-md bg-yellow-300 hover:bg-yellow-400 focus:outline-none focus:ring-2 focus:ring-yellow-300 focus:ring-offset-2 transition ease-in-out duration-150 dark:bg-yellow-300 dark:hover:bg-yellow-400 dark:focus:ring-yellow-200"
                                            title="Cancel Event"
                                        >
                                            <div
                                            ...
                                            >
                                                ...
                                                >
                                                    <path
                                                        d="M12 2a10 10 0 1 0 10 10h-2a8 8 0 1 1-1.73-5H14v2h6V1h-2v4.07A9.93 9.93 0 0 0 12 2z"
                                                    />
                                                </svg>
                ...
                >
                    ...
                    <div class="p-6 pt-0 text-center">
                        ...
                        <div class="mt-8 flex justify-center gap-6">
                            ...
                            <PrimaryButton
                                class="uppercase bg-yellow-300 hover:bg-yellow-400 focus:outline-none focus:ring-2 focus:ring-yellow-300 active:bg-yellow-300 focus:bg-yellow-400 focus:ring-offset-2 transition ease-in-out duration-150 dark:bg-yellow-300 dark:hover:bg-yellow-400 dark:focus:ring-yellow-200"
                                :class="{
